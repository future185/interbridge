        ...
        >
          ...
          >
            <Text style={{ fontSize: "100%" }}>
              {userData?.language === "es" ? (
                <>
                  Gracias <Text style={{fontWeight: "600"}}>@{userData?.name}</Text>
                  <MaterialIcons name="verified" size={15} color="blue" style={{paddingRight: 5, top: 3}} />
                   por completar la sección de resolución de problemas,{" "}
                  {agente.sobreti}
                </>
              ) : userData?.language === "en" ? (
                <>
                  Thank you <Text style={{fontWeight: "600"}}>@{userData?.name}</Text>
                  <MaterialIcons name="verified" size={15} color="blue" style={{paddingRight: 5, top: 3}} />
                  for completing the problem-solving section! {agent.aboutyou}
                </>
              ) : null}
            </Text>
            ...
            >
              <ButtonComponent
                ...
                onPress={() => {
                  setIsLoading(true);
                  router.push(
                    `/about/section_1/id=ok90f-jdjid-s873f${userData?.id}-hg53df`
                  );
                  setIsLoading(false);
                }}
                loading={loading}
