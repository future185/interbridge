            ...
            <Text style={{ fontSize: "100%" }}>
              {userData?.language === "es" ? (
                <>
                  ...
                  cliente y has ganado un bono de $600 dólares. Recibirás las
                  instrucciones de capacitación en tu correo {userData?.email}{" "}
                  La capacitación es pagada a $50 dólares por hora y tiene una
                  duración de dos semanas. Puedes reclamar tu bono ahora o más
                  adelante. ¡Esperamos trabajar contigo!
                </>
              ) : userData?.language === "en" ? (
                <>
                  Congratulations!🎊 @
                  ...
                  earned a $600 bonus. You’ll receive training instructions in
